...
from BookmarkWindow import BookMark
...
class LSMainWindow(QWidget):
    ...
    def __init__(self, widget):
        ...
        self.query.setPlaceholderText('주소를 입력하세요.')
        self.query.setStyleSheet("border:none;background-color:#FFD5DF;font-size:20px;font-family:NanumBarunGothic;")
        self.query.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)

        self.btnSearch = QPushButton()
        self.btnSearch.setStyleSheet("color:#EAEAEA;background-color:#FF2E63;font-weight:bold;font-size:20px;font-family:NanumBarunGothic;")
        ...
        self.lbox.setStyleSheet("border:none;background-color:#FFD5DF;font-size:16px;font-family:NanumBarunGothic;")

        self.btnSave = QPushButton()
        self.btnSave.setStyleSheet("color:#EAEAEA;background-color:#FF2E63;font-weight:bold;font-size:20px;font-family:NanumBarunGothic;")
        ...
        self.btnBookmark.setStyleSheet("color:#EAEAEA;background-color:#FF2E63;font-weight:bold;font-size:20px;font-family:NanumBarunGothic;")
