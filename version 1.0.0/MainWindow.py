...
class MainWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.aLabel.setStyleSheet("font-size:130px;font-family:NanumBarunGothic;")
        self.aLabel.setAlignment(Qt.AlignVCenter)

        self.bLabel = QLabel('Version 1.0.0', self)
        self.bLabel.setMaximumHeight(15)
        self.bLabel.setStyleSheet("font-size:15px;font-family:NanumBarunGothic;")
        self.bLabel.setAlignment(Qt.AlignTop)
        self.bLabel.setAlignment(Qt.AlignHCenter)

        self.bmbtn = QPushButton()
        self.bmbtn.setText('음식점\n즐겨찾기')
        self.bmbtn.setMaximumHeight(100)
        self.bmbtn.setMaximumWidth(300)
        self.bmbtn.setStyleSheet("background-color: #71C9CE;font-size:30px;font-family:NanumBarunGothic;")

        self.rcmdbtn = QPushButton()
        self.rcmdbtn.setText('음식\t\n추천받기')
        self.rcmdbtn.setMaximumHeight(100)
        self.rcmdbtn.setMaximumWidth(300)
        self.rcmdbtn.setStyleSheet("background-color: #71C9CE;font-size:30px;font-family:NanumBarunGothic;")
