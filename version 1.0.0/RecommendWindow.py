...
class RecommendWindow(QWidget):
    ...
    def __init__(self, widget):
        ...
        self.rcmdLabel1_1.setStyleSheet("font-size:50px;border-width:5px;border-style:solid solid none solid;border-color:red;")
        self.rcmdLabel2_1 = QLabel('2nd', self)
        self.rcmdLabel2_1.setMaximumHeight(225)
        self.rcmdLabel2_1.setAlignment(Qt.AlignHCenter)
        self.rcmdLabel2_1.setStyleSheet("font-size:50px;border-width:5px;border-style:solid solid none solid;border-color:green;")
        self.rcmdLabel3_1 = QLabel('3rd', self)
        self.rcmdLabel3_1.setMaximumHeight(160)
        self.rcmdLabel3_1.setAlignment(Qt.AlignHCenter)
        self.rcmdLabel3_1.setStyleSheet("font-size:50px;border-width:5px;border-style:solid solid none solid;border-color:#71C9CE;")
        ...
        self.foodRecommendButton.setStyleSheet("background-color: #71C9CE;font-size:20px;font-family:NanumBarunGothic;")
        ...
        self.foodListCombobox.setStyleSheet("background-color: #71C9CE;font-size:20px;font-family:NanumBarunGothic;")

        self.mapButton = QPushButton()
        self.mapButton.setMaximumHeight(50)
        self.mapButton.setStyleSheet("background-color: #71C9CE;font-size:20px;font-family:NanumBarunGothic;")
